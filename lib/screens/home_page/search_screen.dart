...
import 'package:learnship/screens/search_screen/utils.dart';
...
class SearchScreen extends StatefulWidget {
  ...
  SearchScreen({Key key, this.searchQuery, this.ytApi}) : super(key: key);
  @override
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  // Future<void> uploadingData(String _courseTitle, List<String> _listOfVideos,
  //     String _imageUrl, bool _isFavourite) async {
  //   await FirebaseFirestore.instance.collection("courses").add({
  //     'courseTitle': _courseTitle,
  //     'productPrice': _listOfVideos,
  //   });
  // }
